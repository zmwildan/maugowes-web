...
const { stripTags } = require("string-manager")
 ...
 * @param {array} target list all target email address, sample : ["email1@dot.com", "email2@dot.com"]
 * @param {string} body email body
 */
module.exports.sendEmail = (target = [], subject = "", html = "") => {
